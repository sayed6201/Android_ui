package com.sayed.ahmed.story_app.adapter
...
import com.sayed.ahmed.story_app.ui.MovieDetailActivity
...
class PopularMoviePagedListAdapter( val context: Context) : PagedListAdapter<Movie, RecyclerView.ViewHolder>(MovieDiffCallback()) {
    ...
    //getItemCount to get Movie list number
    //getItem(position) to get current movie..
        ...
        if (hadExtraRow != hasExtraRow) {
            if (hadExtraRow) {                             //hadExtraRow is true and hasExtraRow false
                ...
                notifyItemInserted(super.getItemCount())   //add the progressbar at the end
                                                                    ...
                                                                    // and (NetworkState.ERROR or NetworkState.ENDOFLIST)
